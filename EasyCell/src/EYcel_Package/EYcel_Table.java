...
public class EYcel_Table {
        ...
        public String cellReader(String cell) {
                ...
                } catch(IllegalArgumentException e)
                {
                        ...
                        // TO DO: VERY IMPORTEND: This should be put in the seperate bar for the error message!
...
//                                        loop for the y
                                        ...
                                        {
                                                String coor = "x" + i + "y" + j; 
                                                result.add(getCoorContent(coor));
...
//                Get int y
        ...
        public static String replaceCoor(String hasCoor)
        {
                ...
                while(hasCoor.matches(containsCoor)) {
                        ...
                        String replaced = m.find() ? m.group() : "";
                        
                        hasCoor = hasCoor.replace(replaced, getCoorContent(replaced));
                }
